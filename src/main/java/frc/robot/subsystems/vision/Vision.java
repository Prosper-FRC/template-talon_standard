...
public class Vision {
    ...
    // private ObjectCamIOInputsAutoLogged objectInputsAutoLogged
    //     = new ObjectCamIOInputsAutoLogged();
    ...
    public Vision(VisionIO[] cameras) {
        ...
        // objectCam = new ObjectPV("Arducam_USB_Camera");
    }
    ...
    public void periodic(Pose2d lastRobotPose, Pose2d simOdomPose) {
        ...
        // objectCam.updateInputs(objectInputsAutoLogged);
        // Logger.processInputs("Vision/ObjectCam", objectInputsAutoLogged);
    }
