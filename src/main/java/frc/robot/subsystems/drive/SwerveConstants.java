...
public final class SwerveConstants {
    public record ModuleConstants(int kDriveId, int kAzimuthID, int kCanCoderID, Rotation2d kOffset, String kName) {}
    ...
    public static final double kDriveGearRatio = 6.746031746031747; //6.86:1
    ...
    public static final double kAzimuthP = 2.5;
