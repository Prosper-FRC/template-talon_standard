...
public final class SwerveConstants {
  ...
  public static final class Swerve {
    ...
    public static final double driveKS =
        (0); // divide by 12 to convert from volts to percent output for CTRE
    ...
    public static final class Mod0 {
      ...
      public static Rotation2d angleOffset =
          Rotation2d.fromRotations(-0.333252); // 314.5 these aren't accurate just refrences
      public static final SwerveModuleConstants constants =
          new SwerveModuleConstants(
              driveMotorID, angleMotorID, canCoderID, angleOffset, "Front Left");
    }
    ...
    public static final class Mod1 {
      ...
      public static final SwerveModuleConstants constants =
          new SwerveModuleConstants(
              driveMotorID, angleMotorID, canCoderID, angleOffset, "Front Right");
    }
    ...
    public static final class Mod2 {
      ...
      public static final SwerveModuleConstants constants =
          new SwerveModuleConstants(
              driveMotorID, angleMotorID, canCoderID, angleOffset, "Back Left");
    }
    ...
    public static final class Mod3 {
      ...
      public static final SwerveModuleConstants constants =
          new SwerveModuleConstants(
              driveMotorID, angleMotorID, canCoderID, angleOffset, "Back Right");
    }
  }
