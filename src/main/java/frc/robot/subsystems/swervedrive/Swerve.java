...
public class Swerve extends SubsystemBase {
  ...
  public Swerve() {
    ...
    swerveOdometry =
        new SwerveDriveOdometry(
            SwerveConstants.Swerve.swerveKinematics, getYaw(), getModulePositions());
    poseEstimator =
        new SwerveDrivePoseEstimator(
            SwerveConstants.Swerve.swerveKinematics, getYaw(), getModulePositions(), getPose());
  ...
  public void drive(Translation2d translation, double rotation, boolean isOpenLoop) {
    ...
    SwerveDriveKinematics.desaturateWheelSpeeds(
        swerveModuleStates, SwerveConstants.Swerve.maxSpeed);
  ...
  public void setModuleSpeeds(ChassisSpeeds desiredSpeeds) {
    SwerveDriveKinematics.desaturateWheelSpeeds(
        SwerveConstants.Swerve.swerveKinematics.toSwerveModuleStates(desiredSpeeds),
    ...
    for (SwerveModule mod : mSwerveMods) {
      mod.setDesiredState(
          SwerveConstants.Swerve.swerveKinematics.toSwerveModuleStates(desiredSpeeds)[i], false);
      i += 1;
    }
  }
