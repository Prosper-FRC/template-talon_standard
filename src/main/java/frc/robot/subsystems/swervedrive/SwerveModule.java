...
public class SwerveModule extends SubsystemBase {
    ...
    public void periodic() {
        ...
        SmartDashboard.putNumber(modName + "/ Azimuth / Temperature(C*)", angleMotor.getDeviceTemp().getValueAsDouble());

        SmartDashboard.putNumber(modName + "/ CANcoder / Position(D*)", getCANcoderRawPos().minus(angleOffset).getDegrees());
    }
    ...
    public void setDesiredState(SwerveModuleState desiredState, boolean isOpenLoop) {
        ...
        angleMotor.setControl(turnControl.withPosition(desiredState.angle.getRotations()));  // Set target angle
    ...
    private void configAngleEncoder() {    
        ...
        angleEncoder.getConfigurator().apply(ctreConfigs.swerveCanCoderConfig);  // Apply swerve-specific config
    }
