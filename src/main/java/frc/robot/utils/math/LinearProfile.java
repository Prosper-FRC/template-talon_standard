...
public class LinearProfile {
  ...
  @Getter private double currentSetpoint = 0.0;
  @Getter @Setter private double goal = 0.0;
  @Getter private double currentAcceleration = 0.0;
  @Getter private double maxAcceleration = 0.0;
