...
public class AutonCommands {
  ...
  @AutoLogOutput private AutonState autoState = AutonState.ALLIANCE;
  ...
  public AutonCommands(/* pass subsystems */ ) {
    ...
    // Define Auton choices for the dashboard.  Add a named option, and give it a method of this
    // class to run.
  ...
  // Also write methods that string these actions together into larger actions with
  // SequentialCommandGroup, etc.
  ...
  */
  ...
  // Helper functions can be written to make defining commands easier, and to avoid code
  // duplication.
  /* Example
