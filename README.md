...
There are two main constants that you need for photoelectric sensors, you need the DIO port and if the sensor is flipped, these are two constants that you need to keep track of. 
